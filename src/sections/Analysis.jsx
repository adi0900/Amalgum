...
const Analysis = () => {
  ...
  return (
    <section className="w-full h-auto px-12 max-[599px]:px-4 py-20 max-[599px]:py-6">
      <div className="h-full w-full flex gap-5 max-[599px]:flex-col">
        {products.map((product, index) => (
          <div
          key={index}
          className="product bg-cover relative w-1/2 max-[599px]:w-full h-[20rem] bg-[#003D23] text-white rounded-4xl overflow-hidden"
        >
          {/* Product Image */}
